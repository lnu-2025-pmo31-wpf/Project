...
namespace Project_kindergarten
{
    public partial class admin_add_groups : Form
    {
        ...
        private void LoadTeachersCombo()
        {
            ...
            // Можна створити групу навіть якщо ще нема вихователів у БД
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Будь ласка, заповніть усі поля (крім вихователя — він необов'язковий на цьому кроці).",
            ...
            // Якщо вибрали вихователя — "прикріплюємо" його до нової групи як основного
            if (teacherId > 0)
            {
                ...
                if (teacher != null)
                {
                    ...
                    // У групі може бути лише один "основний" вихователь
            ...
            MessageBox.Show("Групу успішно додано!",
