...
namespace Project_kindergarten.Dialogs
{
    internal sealed class TeacherEditDialog : Form
    {
        ...
        {
            Text = existing == null ? "Додати вихователя" : "Редагувати вихователя";
        ...
        private void BindFromModel()
        {
            ...
            _txtPosition.Text = string.IsNullOrWhiteSpace(Teacher.Position) ? "Вихователь" : Teacher.Position;
        ...
        private bool TryBuildModelFromUi()
        {
            ...
            if (position.Length == 0) position = "Вихователь";
