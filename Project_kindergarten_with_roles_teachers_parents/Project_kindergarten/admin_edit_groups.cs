...
namespace Project_kindergarten
{
    public partial class admin_edit_groups : Form
    {
        ...
        private void LoadTeachersCombo()
        {
            ...
            // Вибираємо основного вихователя цієї групи (якщо є)
        ...
        private void LoadGroupData()
        {
            ...
            count_comboBox.Text = $"{group.MaxChildren} дітей";
        ...
        private void edit_button_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Поточна кількість дітей не може бути більшою за максимальну.",
                    "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            // Якщо вибрали вихователя — робимо його основним для цієї групи
            if (teacherId > 0)
            {
        ...
        // Витягуємо число з тексту типу "15 дітей"
