...
using Project_kindergarten.Dialogs;
...
namespace Project_kindergarten
{
    public partial class admin_personnelcs : Form
    {
        ...
        private void LoadTeachersToGrid()
        {
            ...
            if (dataGridView1.Columns["Group"] != null) dataGridView1.Columns["Group"].HeaderText = "Група";
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            // Якщо ставимо "Основний" — скидаємо інших у цій групі
        ...
        private void RemoveSelectedTeacher()
        {
            ...
            var confirm = MessageBox.Show(
                "Ви точно хочете видалити цього вихователя?",
                "Підтвердження",
